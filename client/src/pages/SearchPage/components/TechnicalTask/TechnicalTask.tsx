                ...
                <div className="searchPage__content__item__search__mainSearch__technicalTaskContainer__content">
                    ...
                    <div
                        ...
                        <div
                            ...
                            {arrayTeeth.map((tooth, index) =>
                                <div key={tooth.id} style={{
                                    borderBottom: tooth.id <= 28 ? "1px solid gray" : "",
                                    borderRight: tooth.id === 18 || tooth.id === 38 ? "1px solid gray" : ""
                                }}
                                     >
                                    <label className="searchPage__content__item__search__mainSearch__technicalTaskContainer__content__teeths__list__item">
                                        <div className="searchPage__content__item__search__mainSearch__technicalTaskContainer__content__teeths__list__item__checkbox">
                                            <Controller
                                                name={`teeth.${index}.${tooth.id}`}
                                                control={control}
                                                defaultValue={false}
                                                rules={{required: true}}
                                        ...
                                        <div className="searchPage__content__item__search__mainSearch__technicalTaskContainer__content__teeths__list__item__tooth">
                                            <img src={tooth.src}/></div>
                                        <div className="searchPage__content__item__search__mainSearch__technicalTaskContainer__content__teeths__list__item__number">{tooth.id}</div>
                                    </label>
                                </div>
                            )}
                        </div>
